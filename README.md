...
## 1.1 Mini Project — The "FinSafe" Transaction Validator
## requirements
...
## 1.2 Pre-training — Banking System Simulation 
## requirements
### java (any version above java 21)
### mysql
### mysql-connector-j (JDBC driver jar on the classpath evironment variables)
## Instructions
...
4. compile all files with `javac BankingApp.java` 
5. run with `java BankingApp`
...
## 2.1 Mini Project —  The "OpsBot" Log Automator 
## requirements
...
## 2.2 Pre-training — Weather Data Analyzer & Forecast Dashboard 
## requirements
### python 3.12 (or above)
...
## 3.1 Mini Project — The "Retail Insights" Data Analyst
## requirements
### mysql
## Instructions
...
## 3.2 Pre-training —  Movie Recommendation & Rating Analysis System
## requirements
### mysql
## Instructions
